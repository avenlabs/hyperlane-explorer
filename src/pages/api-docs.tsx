...
const ApiDocs: NextPage = () => {
  return (
    <div className="mb-2 mt-4 w-full px-2 sm:px-6 lg:pr-14">
      <Card>
        <h2 className="mt-1 text-lg font-medium text-purple-950">
        ...
        <h3 className="mt-5 font-medium text-purple-950">Example Request</h3>
        <div className="mt-2 overflow-auto rounded-xl bg-gray-50 p-2.5 text-sm">
          <pre>
            <code>{exampleRequest}</code>
          </pre>
        </div>
        <h3 className="mt-5 font-medium text-purple-950">Example Response</h3>
        <div className="mt-2 overflow-auto rounded-xl bg-gray-50 p-2.5 text-sm">
          <pre>
        ...
        <h3 className="mt-4 font-medium text-purple-950">API Reference</h3>
